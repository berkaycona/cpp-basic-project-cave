...
//
////first way
//void myFunction5(int* arr, int size) //integer pointer arr as argument
//{
//	cout << "Sending arrays as arguments - First Way";
//}
////second way
//void myFunction5(int(&arr)[5]) //reference to an array of 5 integers as argument
//{
//	cout << "Sending arrays as arguments - Second Way";
//}
////third way
//void myFunction5(int(*arr)[5], int size) //a pointer to an array of integers as argument
//{
//	int element = (*arr)[0];
//	int element2 = *arr[0];
//	//int element3 = arr[0]; ERROR
//
//}
////fourth way (same with first way)
//void myFunction5(int arr[], int size) //integer array arr as arguments.
//{
//	arr[size - 1] = 4;
//	//*arr[2] = 4; operand of "*" must be a pointer but has type ”int" ERROR
//	//&arr[size - 1] = 4; Expression must be a modifiable value ERROR
//	//int element = (*arr)[0]; Expression must have pointer-to-object type but it has type "int" ERROR
//}
//
//using namespace std;
//int main()
...
//	myFunction5(arr, 5);//calls the 1st way, not 4rd way, they are the same
//
//}
//
//
